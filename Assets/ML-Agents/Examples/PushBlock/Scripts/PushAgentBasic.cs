...
public class PushAgentBasic : Agent
{
    ...
    /// </summary>
    [HideInInspector]
    public OutsideDetect outsideDetect;
    ...
    public override void Initialize()
    {
        ...
        outsideDetect = block.GetComponent<OutsideDetect>();
        outsideDetect.agent = this;
    ...
    {
        //punishing the agent almost the same as scoring the goal
        AddReward(-1f);

        // By marking an agent as done AgentReset() will be called automatically.
        EndEpisode();
        
        // Swap ground material for a bit to indicate we .
